  ...
  return (
    <section className="md:container px-6 mt-10 py-10 bg-prussian-blue">
      ...
      <div className='flex flex-col justify-center items-center mt-10 md:mt-16 lg:mt-20'>
        <a href='https://luma.com/gexigzaa' target='_blank' rel='noopener noreferrer' className='text-xl md:text-2xl font-body font-semibold text-gray-50 px-8 md:px-18 py-2 md:py-4 flex gap-2 items-center whitespace-nowrap rounded-full bg-royal-blue'>Register <PiArrowUpRight/>  </a>
      </div>
    </section>
  );
}
