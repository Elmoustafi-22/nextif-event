          ...
          <div className="container mx-auto px-6">
            <div className="text-center">
              ...
              <p className="mt-4 text-lg max-w-4xl mx-auto">
                ...
                future of Islamic finance with integrity and vision. NextIF
                stands as a catalyst for growth, collaboration, and lasting
                impact in the global finance community.
              </p>
            </div>
          </div>
        </motion.section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="mt-4 text-lg">
                  A world class platform where young enthusiasts are empowered
                  to lead and innovate in Islamic finance, supported by a strong
              ...
              >
                ...
                <p className="mt-4 text-lg">
                  ...
                  Islamic finance industry, fostering a new generation of
